...
# Wealthsimple realted Modifications by Elliott de Launay

# ~/.zshrc file for zsh non-login shells.

export LANG="C.UTF-8" # Needed on some docker containers - rather than installing locales
...
if [ -f /usr/local/share/zsh-history-substring-search/zsh-history-substring-search.zsh ]; then
  ...
  # Terminal inside docker is using application mode
  bindkey '^[OA' history-substring-search-up
  bindkey '^[OB' history-substring-search-down
fi
# enable z
if [ -f /usr/local/share/z/z.sh ]; then
